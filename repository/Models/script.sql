...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TimeTracker_AspNetUsers]') AND parent_object_id = OBJECT_ID(N'[dbo].[TimeTracker]'))
ALTER TABLE [dbo].[TimeTracker] DROP CONSTRAINT [FK_TimeTracker_AspNetUsers]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskMaster_TaskTypeMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskMaster]'))
ALTER TABLE [dbo].[TaskMaster] DROP CONSTRAINT [FK_TaskMaster_TaskTypeMaster]
GO
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskMaster_AspNetUsersReporter]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskMaster]'))
ALTER TABLE [dbo].[TaskMaster] DROP CONSTRAINT [FK_TaskMaster_AspNetUsersReporter]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskMaster_AspNetUsersAssigny]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskMaster]'))
ALTER TABLE [dbo].[TaskMaster] DROP CONSTRAINT [FK_TaskMaster_AspNetUsersAssigny]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskCategory_Project]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskCategory]'))
ALTER TABLE [dbo].[TaskCategory] DROP CONSTRAINT [FK_TaskCategory_Project]
GO
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ProjectAssigny_Project1]') AND parent_object_id = OBJECT_ID(N'[dbo].[ProjectAssigny]'))
ALTER TABLE [dbo].[ProjectAssigny] DROP CONSTRAINT [FK_ProjectAssigny_Project1]
GO
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_CommentMaster_AspNetUsers]') AND parent_object_id = OBJECT_ID(N'[dbo].[CommentMaster]'))
ALTER TABLE [dbo].[CommentMaster] DROP CONSTRAINT [FK_CommentMaster_AspNetUsers]
GO
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ChatMaster_AspNetUsers]') AND parent_object_id = OBJECT_ID(N'[dbo].[ChatMaster]'))
ALTER TABLE [dbo].[ChatMaster] DROP CONSTRAINT [FK_ChatMaster_AspNetUsers]
GO
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Activity_AspNetUsers]') AND parent_object_id = OBJECT_ID(N'[dbo].[Activity]'))
ALTER TABLE [dbo].[Activity] DROP CONSTRAINT [FK_Activity_AspNetUsers]
GO
...
GO
/****** Object:  Table [dbo].[TimeTracker]    Script Date: 06-09-2019 09:57:01 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[TimeTracker]') AND type in (N'U'))
DROP TABLE [dbo].[TimeTracker]
GO
/****** Object:  Table [dbo].[TaskTypeMaster]    Script Date: 06-09-2019 09:57:01 AM ******/
...
GO
/****** Object:  Table [dbo].[TaskStatusMaster]    Script Date: 06-09-2019 09:57:01 AM ******/
...
GO
/****** Object:  Table [dbo].[TaskMaster]    Script Date: 06-09-2019 09:57:01 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[TaskMaster]') AND type in (N'U'))
DROP TABLE [dbo].[TaskMaster]
GO
/****** Object:  Table [dbo].[TaskCategory]    Script Date: 06-09-2019 09:57:01 AM ******/
...
GO
/****** Object:  Table [dbo].[TaskAttachment]    Script Date: 06-09-2019 09:57:01 AM ******/
...
GO
/****** Object:  Table [dbo].[ProjectStatusMaster]    Script Date: 06-09-2019 09:57:01 AM ******/
...
GO
/****** Object:  Table [dbo].[ProjectCategory]    Script Date: 06-09-2019 09:57:01 AM ******/
...
GO
/****** Object:  Table [dbo].[ProjectAttachment]    Script Date: 06-09-2019 09:57:01 AM ******/
...
GO
/****** Object:  Table [dbo].[ProjectAssigny]    Script Date: 06-09-2019 09:57:01 AM ******/
...
GO
/****** Object:  Table [dbo].[Project]    Script Date: 06-09-2019 09:57:01 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Project]') AND type in (N'U'))
DROP TABLE [dbo].[Project]
GO
/****** Object:  Table [dbo].[PriorityMaster]    Script Date: 06-09-2019 09:57:01 AM ******/
...
GO
/****** Object:  Table [dbo].[DependantTask]    Script Date: 06-09-2019 09:57:01 AM ******/
...
GO
/****** Object:  Table [dbo].[CommentMaster]    Script Date: 06-09-2019 09:57:01 AM ******/
...
GO
/****** Object:  Table [dbo].[ChatMaster]    Script Date: 06-09-2019 09:57:01 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ChatMaster]') AND type in (N'U'))
DROP TABLE [dbo].[ChatMaster]
GO
/****** Object:  Table [dbo].[AspNetUsers]    Script Date: 06-09-2019 09:57:01 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[AspNetUsers]') AND type in (N'U'))
DROP TABLE [dbo].[AspNetUsers]
GO
/****** Object:  Table [dbo].[AspNetUserRoles]    Script Date: 06-09-2019 09:57:01 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[AspNetUserRoles]') AND type in (N'U'))
DROP TABLE [dbo].[AspNetUserRoles]
GO
/****** Object:  Table [dbo].[AspNetUserLogins]    Script Date: 06-09-2019 09:57:01 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[AspNetUserLogins]') AND type in (N'U'))
DROP TABLE [dbo].[AspNetUserLogins]
GO
/****** Object:  Table [dbo].[AspNetUserClaims]    Script Date: 06-09-2019 09:57:01 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[AspNetUserClaims]') AND type in (N'U'))
DROP TABLE [dbo].[AspNetUserClaims]
GO
/****** Object:  Table [dbo].[AspNetRoles]    Script Date: 06-09-2019 09:57:01 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[AspNetRoles]') AND type in (N'U'))
DROP TABLE [dbo].[AspNetRoles]
GO
/****** Object:  Table [dbo].[Activity]    Script Date: 06-09-2019 09:57:01 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Activity]') AND type in (N'U'))
DROP TABLE [dbo].[Activity]
GO
/****** Object:  Table [dbo].[__MigrationHistory]    Script Date: 06-09-2019 09:57:01 AM ******/
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Activity_AspNetUsers]') AND parent_object_id = OBJECT_ID(N'[dbo].[Activity]'))
ALTER TABLE [dbo].[Activity]  WITH CHECK ADD  CONSTRAINT [FK_Activity_AspNetUsers] FOREIGN KEY([UserId])
REFERENCES [dbo].[AspNetUsers] ([Id])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Activity_AspNetUsers]') AND parent_object_id = OBJECT_ID(N'[dbo].[Activity]'))
ALTER TABLE [dbo].[Activity] CHECK CONSTRAINT [FK_Activity_AspNetUsers]
GO
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ChatMaster_AspNetUsers]') AND parent_object_id = OBJECT_ID(N'[dbo].[ChatMaster]'))
ALTER TABLE [dbo].[ChatMaster]  WITH CHECK ADD  CONSTRAINT [FK_ChatMaster_AspNetUsers] FOREIGN KEY([UserId])
REFERENCES [dbo].[AspNetUsers] ([Id])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ChatMaster_AspNetUsers]') AND parent_object_id = OBJECT_ID(N'[dbo].[ChatMaster]'))
ALTER TABLE [dbo].[ChatMaster] CHECK CONSTRAINT [FK_ChatMaster_AspNetUsers]
GO
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_CommentMaster_AspNetUsers]') AND parent_object_id = OBJECT_ID(N'[dbo].[CommentMaster]'))
ALTER TABLE [dbo].[CommentMaster]  WITH CHECK ADD  CONSTRAINT [FK_CommentMaster_AspNetUsers] FOREIGN KEY([UserId])
REFERENCES [dbo].[AspNetUsers] ([Id])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_CommentMaster_AspNetUsers]') AND parent_object_id = OBJECT_ID(N'[dbo].[CommentMaster]'))
ALTER TABLE [dbo].[CommentMaster] CHECK CONSTRAINT [FK_CommentMaster_AspNetUsers]
GO
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ProjectAssigny_Project1]') AND parent_object_id = OBJECT_ID(N'[dbo].[ProjectAssigny]'))
ALTER TABLE [dbo].[ProjectAssigny]  WITH CHECK ADD  CONSTRAINT [FK_ProjectAssigny_Project1] FOREIGN KEY([ProjectId])
REFERENCES [dbo].[Project] ([ProjectId])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ProjectAssigny_Project1]') AND parent_object_id = OBJECT_ID(N'[dbo].[ProjectAssigny]'))
ALTER TABLE [dbo].[ProjectAssigny] CHECK CONSTRAINT [FK_ProjectAssigny_Project1]
GO
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskCategory_Project]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskCategory]'))
ALTER TABLE [dbo].[TaskCategory]  WITH CHECK ADD  CONSTRAINT [FK_TaskCategory_Project] FOREIGN KEY([ProjectId])
REFERENCES [dbo].[Project] ([ProjectId])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskCategory_Project]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskCategory]'))
ALTER TABLE [dbo].[TaskCategory] CHECK CONSTRAINT [FK_TaskCategory_Project]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskMaster_AspNetUsersAssigny]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskMaster]'))
ALTER TABLE [dbo].[TaskMaster]  WITH CHECK ADD  CONSTRAINT [FK_TaskMaster_AspNetUsersAssigny] FOREIGN KEY([AssignyId])
REFERENCES [dbo].[AspNetUsers] ([Id])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskMaster_AspNetUsersAssigny]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskMaster]'))
ALTER TABLE [dbo].[TaskMaster] CHECK CONSTRAINT [FK_TaskMaster_AspNetUsersAssigny]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskMaster_AspNetUsersReporter]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskMaster]'))
ALTER TABLE [dbo].[TaskMaster]  WITH CHECK ADD  CONSTRAINT [FK_TaskMaster_AspNetUsersReporter] FOREIGN KEY([ReporterId])
REFERENCES [dbo].[AspNetUsers] ([Id])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskMaster_AspNetUsersReporter]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskMaster]'))
ALTER TABLE [dbo].[TaskMaster] CHECK CONSTRAINT [FK_TaskMaster_AspNetUsersReporter]
GO
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskMaster_TaskTypeMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskMaster]'))
ALTER TABLE [dbo].[TaskMaster]  WITH CHECK ADD  CONSTRAINT [FK_TaskMaster_TaskTypeMaster] FOREIGN KEY([TaskTypeMasterId])
REFERENCES [dbo].[TaskTypeMaster] ([TaskTypeMasterId])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskMaster_TaskTypeMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskMaster]'))
ALTER TABLE [dbo].[TaskMaster] CHECK CONSTRAINT [FK_TaskMaster_TaskTypeMaster]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TimeTracker_AspNetUsers]') AND parent_object_id = OBJECT_ID(N'[dbo].[TimeTracker]'))
ALTER TABLE [dbo].[TimeTracker]  WITH CHECK ADD  CONSTRAINT [FK_TimeTracker_AspNetUsers] FOREIGN KEY([UserMasterId])
REFERENCES [dbo].[AspNetUsers] ([Id])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TimeTracker_AspNetUsers]') AND parent_object_id = OBJECT_ID(N'[dbo].[TimeTracker]'))
ALTER TABLE [dbo].[TimeTracker] CHECK CONSTRAINT [FK_TimeTracker_AspNetUsers]
GO
