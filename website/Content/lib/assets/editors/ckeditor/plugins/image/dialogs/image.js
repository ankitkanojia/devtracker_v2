        ...
        return{
            ...
            onShow: function() {
                ...
                (d = a.getItem(0), d.type == CKEDITOR.NODE_ELEMENT &&
                    ...
                    (this.imageElement = a.getItem(0), this.imageElement.is("img")
                        ? this.imageEditMode =
                        "img"
                        : this.imageElement.is("input") && (this.imageEditMode = "input"))), "image" == l &&
            ...
            onHide: function() {
                ...
                (this.originalElement.removeListener("load",
                        u), this.originalElement.removeListener("error", h),
                                    ...
                                    children: [
                                        {
                                            ...
                                            onChange: function() {
                                                ...
                                                if (0 < b.length) {
                                                    ...
                                                    a.preview &&
                                                    (x.setAttribute("src", b), a.preview.setAttribute("src",
                                                        x.$.src), e(a))
                                                } else
                                                    a.preview &&
