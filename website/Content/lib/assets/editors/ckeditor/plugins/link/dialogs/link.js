    ...
    CKEDITOR.dialog.add("link",
        function(g) {
            var n = CKEDITOR.plugins.link,
                ...
                f = function(a) { a.target && this.setValue(a.target[this.id] || "") },
                h = function(a) { a.advanced && this.setValue(a.advanced[this.id] || "") },
                k = function(a) {
                    a.target || (a.target = {});
                        ...
                        elements: [
                            {
                                ...
                                onChange: function() {
                                    var a = this.getDialog(),
                                        ...
                                        e = e && e.hidden;
                                    "url" == m
                                        ? (g.config.linkShowTargetTab && a.showPage("target"), e || a.showPage("upload")
                                        )
                                        : (a.hidePage("target"), e || a.hidePage("upload"));
                                    for (e = 0; e < b.length; e++) {
                                        var c = a.getContentElement("info", b[e]);
                                        c &&
                                        (c = c.getElement().getParent().getParent(), b[e] == m + "Options"
                                            ? c.show()
                                            : c.hide())
                                    }
                                    a.layout()
                                        ...
                                        children: [
                                            {
                                                ...
                                                onKeyUp: function() {
                                                    ...
                                                    c
                                                        ? (this.setValue(b.substr(c[0].length)), a.setValue(
                                                            c[0].toLowerCase()))
                                                        : m.test(b) && a.setValue("");
                                ...
                                children: [
                                    {
                                        ...
                                        style: "width : 100%;",
                                        items: [
                                            [c.notSet, "notSet"], [b.targetFrame, "frame"], [b.targetPopup, "popup"],
                                            [c.targetNew, "_blank"], [c.targetTop, "_top"], [c.targetSelf, "_self"],
                                        ...
                                        children: [
                                            {
                                                ...
                                                "default": "",
                                                id: "advStyles",
                                                validate: CKEDITOR.dialog.validate.inlineStyle(g.lang.common
                                                    .invalidInlineStyle),
                                                setup: h,
                                                commit: l
                                            }
                ...
                onOk: function() {
                    ...
                    if (this._.selectedElement) {
                        ...
                        if (d == f || "email" == a.type && -1 != f.indexOf("@"))
                            e.setHtml("email" == a.type ? a.email.address : c.set["data-cke-saved-href"]), b
                                .selectElement(e);
                        ...
                        (a = new CKEDITOR.dom.text(
                            ...
                            g.document), b.insertNode(a), b.selectNodeContents(a)), c =
                            new CKEDITOR.style({ element: "a", attributes: c.set }), c.type =
                            CKEDITOR.STYLE_INLINE, c.applyToRange(b, g), b.select()
                },
                onLoad: function() {
