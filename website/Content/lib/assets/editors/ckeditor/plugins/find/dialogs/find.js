...
*/
(function() {
    function C(c) { return c.type == CKEDITOR.NODE_TEXT && 0 < c.getLength() && (!r || !c.isReadOnly()) }
    ...
    function q(c, g) {
        function n(a, b) {
            ...
            c.guard = b ? w : function(a) { !w(a) && (d._.matchBoundary = !0) };
            c.evaluator = C;
            c.breakOnFalse = 1;
            a.startContainer.type == CKEDITOR.NODE_TEXT &&
            (this.textNode = a.startContainer, this.offset = a.startOffset -
                1);
        ...
        n.prototype = {
            ...
            move: function(a) {
                ...
                if (b && a && 0 < this.offset) this.offset--;
                    ...
                    for (b = null;
                        !b &&
                            !(b = this._.walker[a ? "previous" : "next"].call(this._.walker), this._.matchWord && !b ||
                                this._.walker._.end);
                    );
            ...
            e = {
                ...
                replace: function(a, b, d, f, e, g, k) {
                    ...
                    if (!this.matchRange ||
                        ...
                        a &&
                                this.matchRange &&
                                (this.matchRange.clearMatched(), this.matchRange.removeHighlight(), this.matchRange =
                                    null),
                ...
                this.selectPage = CKEDITOR.tools.override(this.selectPage,
                    function(f) {
                        return function(e) {
                            ...
                            g.initialized ||
                            (CKEDITOR.document.getById(b._.inputId), g.initialized =
                                !0);
                            if (c) {
                                var l;
                                e = "find" === e ? 1 : 0;
    ...
    var r,
        ...
        v = [
            [
                "txtFindFind",
                "txtFindReplace"
            ], ["txtFindCaseChk", "txtReplaceCaseChk"], ["txtFindWordChk", "txtReplaceWordChk"],
            ["txtFindCyclic", "txtReplaceCyclic"]
        ];
    CKEDITOR.dialog.add("find", function(c) { return q(c, "find") });
    CKEDITOR.dialog.add("replace", function(c) { return q(c, "replace") })
})();