CKEDITOR.dialog.add("pbckcodeDialog",
    function(b) {
        var f = ["1", "2", "4", "8"], g, e = new PBSyntaxHighlighter(b.settings.highlighter), c, d, h;
        return{
                    ...
                    elements: [
                        {
                            ...
                            children: [
                                {
                                    ...
                                    setup: function(a) {
                                        a &&
                                        (a = a.getAscendant("pre", !0), this.setValue(
                                            a.getAttribute("data-pbcklang")))
                                    },
                                    commit: function(a) {
                                        a &&
                                        (a = a.getAscendant("pre", !0), a.setAttribute("data-pbcklang",
                                            this.getValue()))
                                    },
                                    onChange: function() { d.setMode("ace/mode/" + this.getValue()) }
                                }, {
                                    type: "select",
                                    ...
                                    setup: function(a) {
                                        a &&
                                        (a = a.getAscendant("pre", !0), this.setValue(
                                            a.getAttribute("data-pbcktabsize")))
                                    },
                                    commit: function(a) {
                                        a &&
                                        (a = a.getAscendant("pre", !0), a.setAttribute("data-pbcktabsize",
                                            this.getValue()))
                                    },
                                    onChange: function(a) {
                                        a &&
                                        (h.convertIndentation(d,
                                            " ",
                            ...
                            commit: function(a) { a.setText(c.getValue()) }
                        }
                    ]
                }
            ],
            ...
            onShow: function() {
                ...
                !a || "pre" !== a.getName()
                    ? (a = new CKEDITOR.dom.element("pre"), "pre" !==
                        e.getTag() &&
                        a.append(new CKEDITOR.dom.element("code")), this.insertMode = !0)
                    : ("pre" !== e.getTag() && (a = a.getChild(0)), this.insertMode = !1);
                this.element = a;
                c.focus();
                c.setValue("");
            ...
            onOk: function() {
                ...
                a = c = this.element;
                this.insertMode
                    ? "pre" !== e.getTag() && (c = this.element.getChild(0))
                    : a = c.getAscendant("pre", !0);
