...
*/
(function() {
    function z(a) { return a && a.domId && a.getInputElement().$ ? a.getInputElement() : a && a.$ ? a : !1 }
    ...
    var J = function(b) {
        ...
        K = function(b) {
            var c, e, d;
            for (d in b)
                c = a.dialog.getContentElement(a.dialog._.currentTabId, d), c || (c = b[d].instance), c.setLabel &&
                    (e = b[d].localizationID || d, c.setLabel(a.LocalizationComing[e] + ":"))
        },
        r,
        A;
    ...
    a.sendData = function(b) {
        ...
        var h = function(h) {
            ...
            h.data.getTarget().is("a") &&
                c !== a.previousTab &&
                (a.previousTab = c, e = b._.contents[c].Content, d =
                    a.iframeNumber + "_" + c, a.div_overlay.setEnable(), e.getElement().getChildCount()
                    ? E(a.targetFromFrame[d], a.cmd[c])
                    : (a.setIframe(e, c), f = document.getElementById(d), a.targetFromFrame[d] = f.contentWindow))
        };
    ...
    a.buildOptionLang = function(b, c) {
        ...
        if (0 === e.options.length) {
            ...
            for (var p = 0; p < k.length; p++)
                f = document.createElement("option"), f.setAttribute("value", k[p][1]), h =
                    document.createTextNode(k[p][0]), f.appendChild(h), d.appendChild(f);
            e.appendChild(d)
        }
    ...
    var B = function(a) {
        ...
        M = function(b) {
            ...
            "no_any_suggestions" == b
                ? (b = "No suggestions", c =
                    ...
                    a.LocalizationButton.ChangeTo_button.instance, c.disable(), c =
                    a.dialog.getContentElement(a.dialog._.currentTabId, "ChangeAll") ||
                    a.LocalizationButton.ChangeAll.instance, c.disable(), e("ChangeTo_button"), e("ChangeAll"))
        ...
        x = function() { a.dialog.hidePage("Thesaurus") },
        t = function() { a.dialog.hidePage("GrammTab") },
        l = function() { a.dialog.showPage("SpellTab") },
        v = function() {
        ...
        N = function() {
            ...
            setTimeout(function() {
                    ...
                    if (g.misc.hasClass(c, "cke_dialog_tab") ||
    ...
    CKEDITOR.dialog.add("checkspell",
        function(b) {
            function c(a) {
                ...
                a._.moved ||
                (q = isNaN(c) && isNaN(d) ? 0 : 1, isNaN(c) && (c = (m.width - n.width) / 2), 0 > c && (c = 0),
                    c > m.width - n.width && (c = m.width - n.width), isNaN(d) && (d = (m.height - n.height) / 2),
                    0 > d && (d = 0), d > m.height - n.height && (d = m.height - n.height), a.move(c,
                        d,
                        q))
            }
                ...
                onShow: function() {
                    ...
                    if (CKEDITOR && CKEDITOR.config) {
                        ...
                        var d = "file:" == document.location.protocol ? "http:" : document.location.protocol,
                            d = b.config.wsc_customLoaderScript ||
                                d +
                            ...
                            function(c) {
                                ...
                                (b.wsc.isSsrvSame = function() {
                                    ...
                                    window.SCAYT &&
                                        ...
                                        (f = SCAYT.CKSCAYT.prototype.basePath, f.split("//"), g =
                                            f.split("//")[1].split("/")[0], p =
                                    ...
                                    !d ||
                                        ...
                                        (d.split("//"), e = d.split("//")[1].split("/")[0],
                                            h = d.split(e + "/")[1].replace("/lf/scayt3/ckscayt/ckscayt.js", "") +
                                                "/script/ssrv.cgi");
                                    return"//" + a + c ===
                                        "//" +
                                    ...
                                    c = function(a) {
                                        ...
                                        (a = JSON.parse(a.data), a.ud && "undefined" !== a.ud
                                            ...
                                            a.udn && "undefined" !== a.udn
                                                ? b.wsc.udn = a.udn
                                                : "undefined" === a.udn && (b.wsc.udn = void 0), b.wsc.syncIsDone ||
                                            (h(b.wsc.ud),
                                                b.wsc.syncIsDone = !0))
                                    };
                                    var h = function(c) {
                    ...
                    if (b.plugins.scayt && b.wsc && b.wsc.isSsrvSame) {
                        ...
                        b.scayt
                            ? (c
                                ...
                                : (b.wsc.DataStorage.setData("scayt_user_dictionary_name", ""), b.scayt
                                    .removeUserDictionary()), e &&
                                setTimeout(function() {
                                        f = e.split(",");
                            ...
                            : (c
                                ? b.wsc.DataStorage.setData("scayt_user_dictionary_name", c)
                                : b.wsc.DataStorage.setData("scayt_user_dictionary_name", ""), e &&
                                (f = e.split(","), b.wsc.DataStorage.setData("scayt_user_dictionary", f)))
                    }
                },
                contents: [
                    {
    ...
    CKEDITOR.dialog.on("resize",
        function(b) {
            ...
            "checkspell" == c._.name &&
            (a.bnr ? e && e.setSize("height", b.height - 310) : e && e.setSize("height", b.height - 220),
                c._.fromResizeEvent && !c._.resized && (c._.resized = !0), c._.fromResizeEvent = !0)
        });
    CKEDITOR.on("dialogDefinition",
        function(b) {
            if ("checkspell" === b.data.name) {
                ...
                a.onLoadOverlay =
                    new B({ opacity: "1", background: "#fff", target: c.dialog.parts.tabs.getParent().$ });
