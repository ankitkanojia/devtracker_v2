...
CKEDITOR.dialog.add("cellProperties",
    function(g) {
        ...
        function l(a) { if (a = n.exec(a.getStyle("width") || a.getAttribute("width"))) return a[2] }
                                    ...
                                    children: [
                                        {
                                            ...
                                            "default": "",
                                            items: [
                                                [e.notSet, ""], [e.alignLeft, "left"], [e.alignCenter, "center"],
                                                [e.alignRight, "right"], [e.alignJustify, "justify"]
                                            ],
                                            setup: d(function(a) {
                                            ...
                                            "default": "",
                                            items: [
                                                [e.notSet, ""], [e.alignTop, "top"], [e.alignMiddle, "middle"],
                                                [e.alignBottom, "bottom"], [c.alignBaseline, "baseline"]
                                            ],
                                            setup: d(function(a) {
