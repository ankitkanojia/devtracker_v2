...
(function() {
    function C(a) {
        ...
        for (var c = D.length, b = 0, f = 0; f < c; ++f)
            for (var d = D[f], e = d[1].length; a.substr(0, e) == d[1]; a = a.substr(e)) b += d[0];
        return b
    }
    ...
    var G = /^(?:\b0[^\s]*\s*){1,4}$/,
            ...
            utils: {
                ...
                resolveList: function(a) {
                    ...
                    if ((b = a.removeAnyChildWithName("cke:listbullet")) && b.length && (b = b[0]))
                        ...
                        (c.style = H.filters.stylesFilter([
                    ...
                    for (var d = a.children, e, k = 0; k < d.length; k++)
                        if (e = d[k], e.name in CKEDITOR.dtd.$listItem) {
                            ...
                            n.attributes &&
                                ...
                                (e.attributes.style = n.attributes.style, n.replaceWithChildren());
                ...
                assembleList: function(a) {
                    ...
                    for (var g, n, h, p, m, t, q = 0; q < c.length; q++)
                        if (b = c[q], "cke:li" == b.name)
                            if (b.name = "li", f = b.attributes, h =
                                    (h = f["cke:listsymbol"]) && h.match(/^(?:[(]?)([^\s]+?)([.)]?)$/),
                                p = m = t = null, f["cke:ignored"]) c.splice(q--, 1);
                            else {
                                            ...
                                            for (var y in B[u])
                                                if (B[u][y].test(h[1]))
                                                    if ("ol" == u && /alpha|roman/.test(y)) {
                                                        if (g = /roman/.test(y) ? C(h[1]) : E(h[1]), !t || g < t)
                                                            t = g, p = u, m = y
                                                    } else {
                                                        p = u;
                                                        m = y;
                                ...
                                if (l) {
                                    if (d > e) a.push(l = new CKEDITOR.htmlParser.element(p)), l.add(b), k.add(l);
                                    else {
                                        if (d < e) {
                                            e -= d;
                    ...
                    for (q = 0; q < a.length; q++)
                        if (l = a[q], u = l.children, g = g = void 0, y = l.children.length,
                            v = g = void 0, c = /list-style-type:(.*?)(?:;|$)/, e =
                                CKEDITOR.plugins.pastefromword.filters.stylesFilter, g =
                                l.attributes, !c.exec(g.style)) {
                            for (k = 0; k < y; k++)
                                if (g = u[k], g.attributes.value &&
                        ...
                        (b || "").replace(/&quot;/g, '"').replace(/\s*([^ :;]+)\s*:\s*([^;]+)\s*(?=;|$)/g,
                            function(b, e, g) {
                                ...
                                for (var n, h, p, m = 0; m < a.length; m++)
                                    if (a[m] &&
                                    (b = a[m][0], n = a[m][1], h = a[m][2], p =
                                        a[m][3], e.match(b) && (!n || g.match(n)))) {
                                        e = p || e;
                                        c && (h = h || g);
                    ...
                    elements: {
                        ...
                        $: function(a) {
                            ...
                            if (z.match(/h\d/)) {
                                ...
                                if (u(a)) return;
                                g(d["format_" + z])(a)
                            } else if (z in b.$inline) a.filterChildren(c), q(a) && delete a.name;
                        ...
                        p: function(a) {
                            if (/MsoListParagraph/i.exec(a.attributes["class"]) ||
                                ...
                                var b = a.firstChild(
                                    function(a) { return a.type == CKEDITOR.NODE_TEXT && !q(a.parent) });
                        ...
                        font: function(a) {
                            if (t(a.parent)) delete a.name;
                                ...
                                "font" == e.name
                                    ? (CKEDITOR.tools.extend(e.attributes, a.attributes), d && e.addStyle(d), delete a
                                        .name)
                                    : (d = (d || "").split(";"), b.color &&
                                        ("#000000" != b.color && d.push("color:" + b.color), delete b.color), b.face &&
                                        (d.push("font-family:" + b.face), delete b.face), b.size &&
                                    (d.push("font-size:" + (3 < b.size ? "large" : 3 > b.size ? "small" : "medium")),
                                        delete b.size), a.name = "span", a.addStyle(d.join(";")))
                            }
                        },
                        span: function(a) {
                            ...
                            if (t(a)) {
                                ...
                                if (e)
                                    return b = h(e, b), (a = a.getAncestor("span")) &&
                                        / mso-hide:\s*all|display:\s*none /.test(a.attributes.style) &&
                                        (b.attributes["cke:ignored"] = 1), b
                            }
                            if (e = (b = a.attributes) && b.style)
                                b.style = l([
                                        ["line-height"], [/^font-family$/, null, r ? null : n(d.font_style, "family")],
                                        [/^font-size$/, null, r ? null : n(d.fontSize_style, "size")],
                                        [/^color$/, null, r ? null : n(d.colorButton_foreStyle, "color")],
                                        [/^background-color$/, null, r ? null : n(d.colorButton_backStyle, "color")]
                                    ])(e, a) ||
                                    "";
                    ...
                    attributes: {
                        style: l(w
                            ...
                            : [
                                ...
                                ], [/^margin$/, G], ["text-indent", "0cm"], ["page-break-before"], ["tab-stops"],
                                ["display", "none"], r ? [/font-?/] : null
                            ],
                            w),
        ...
        J = function() { this.dataFilter = new CKEDITOR.htmlParser.filter };
    J.prototype = {
        toHtml: function(a) {
    ...
    CKEDITOR.cleanWord = function(a, c) {
        ...
        CKEDITOR.env.gecko &&
            (a = a.replace(/(\x3c!--\[if[^<]*?\])--\x3e([\S\s]*?)\x3c!--(\[endif\]--\x3e)/gi, "$1$2$3"));
        CKEDITOR.env.webkit &&
        (a = a.replace(
