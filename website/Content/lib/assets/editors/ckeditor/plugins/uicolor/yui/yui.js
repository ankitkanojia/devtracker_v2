...
YAHOO.namespace = function() {
    ...
    for (a = 0; a < c.length; a += 1)
        for (b = ("" + c[a]).split("."), e = YAHOO, d = "YAHOO" == b[0] ? 1 : 0; d < b.length; d += 1)
            e[b[d]] = e[b[d]] || {}, e = e[b[d]];
    return e
};
...
YAHOO.env.getVersion = function(c) { return YAHOO.env.modules[c] || null };
YAHOO.env.ua = function() {
    var c = { ie: 0, opera: 0, gecko: 0, webkit: 0, mobile: null, air: 0, caja: 0 }, e = navigator.userAgent, a;
    ...
    if (!c.webkit)
        if ((a = e.match(/Opera[\s\/]([^\s]*)/)) && a[1]) {
            ...
            a[1]) c.ie = parseFloat(a[1]);
        else if (a =
            e.match(/Gecko\/([^\s]*)/))
            c.gecko = 1, (a = e.match(/rv:([^\s\)]*)/)) && a[1] && (c.gecko = parseFloat(a[1]));
...
(function() {
    var c = YAHOO.lang,
        ...
        a = ["toString", "valueOf"],
        d = {
            isArray: function(b) { return"[object Array]" === e.toString.apply(b) },
            isBoolean: function(b) { return"boolean" === typeof b },
            isFunction: function(b) { return"[object Function]" === e.toString.apply(b) },
            isNull: function(b) { return null === b },
            isNumber: function(b) { return"number" === typeof b && isFinite(b) },
            isObject: function(b) { return b && ("object" === typeof b || c.isFunction(b)) || !1 },
            ...
            dump: function(b, a) {
                ...
                if (c.isObject(b)) {
                    if (b instanceof
                        Date ||
                        "nodeType" in b && "tagName" in b) return b;
                ...
                if (c.isArray(b)) {
                    ...
                    for (e = b.length; d < e; d += 1)
                        c.isObject(b[d]) ? k.push(0 < a ? c.dump(b[d], a - 1) : "{...}") : k.push(b[d]), k.push(", ");
                    1 < k.length && k.pop();
                    k.push("]")
                } else {
                    k.push("{");
                    for (d in b)
                        ...
                        (k.push(d + " \x3d\x3e "), c.isObject(b[d])
            ...
            substitute: function(b,
                ...
                for (var h, k, l, m, n, p = [], q;;) {
                    ...
                    c.isObject(l)
                        ...
                        : (n = n || "", m = n.indexOf("dump"), -1 < m && (n = n.substring(4)), l =
                            l.toString === e.toString || -1 < m ? c.dump(l, parseInt(n, 10)) : l.toString())
                        : c.isString(l) || c.isNumber(l) || (l = "~-" + p.length + "-~", p[p.length] = q);
                    b = b.substring(0, h) + l + b.substring(k + 1)
                }
                for (h =
                        p.length - 1;
                    0 <= h;
                    --h) b = b.replace(new RegExp("~-" + h + "-~"), "{" + p[h] + "}", "g");
                return b
            },
            trim: function(b) {
                try {
            ...
            later: function(b, a, d, e, k) {
                ...
                c.isArray(m) || (m = [e]);
                d = function() { l.apply(a, m) };
                n = k ? setInterval(d, b) : setTimeout(d, b);
                return{ interval: k, cancel: function() { this.interval ? clearInterval(n) : clearTimeout(n) } }
            },
            isValue: function(b) { return c.isObject(b) || c.isString(b) || c.isNumber(b) || c.isBoolean(b) }
        };
    c.hasOwnProperty = e.hasOwnProperty
        ? function(b, a) { return b && b.hasOwnProperty(a) }
        : function(b, a) { return!c.isUndefined(b[a]) && b.constructor.prototype[a] !== b[a] };
...
(function() {
    ...
    c.Dom = {
        ...
        get: function(b) {
            ...
            if (b) {
                ...
                if ("string" === typeof b) {
                    ...
                    if ((!b || b.id !== a) && b && k.all)
                        for (b =
                                null, d = k.all[a], f = 0, e = d.length;
                            f < e;
                            ++f) if (d[f].id === a) return d[f];
                    return b
                }
        ...
        getStyle: function(b, a) { return c.Dom.batch(b, c.Dom._getStyle, a) },
        _getStyle: function() {
                ...
                ? function(b, a) {
                    ...
                    if (b)
                        ...
                        case "opacity":
                            ...
                            (b.style.filter =
                                "alpha(opacity\x3d" + 100 * f + ")", b.currentStyle && b.currentStyle.hasLayout ||
                                (b.style.zoom = 1));
                            break;
                        case "float":
                            d = "styleFloat";
        ...
        getXY: function(b) { return c.Dom.batch(b, c.Dom._getXY) },
            ...
            return k.documentElement.getBoundingClientRect
                ? function(b) {
                    ...
                    if (c.Dom._canPosition(b)) {
                        ...
                        q &&
                            8 > a.ie &&
                            (l = g = 2, h = e.compatMode, p = r(e.documentElement, "borderLeftWidth"), e =
                                    r(e.documentElement, "borderTopWidth"), 6 === a.ie &&
                                    "BackCompat" !== h &&
                                    (l = g = 0),
                                "BackCompat" == h &&
                                ("medium" !== p &&
                                    (g = parseInt(p, 10)), "medium" !== e && (l = parseInt(e, 10))), f[0] -= g, f[1] -=
                                    l);
                        if (d || b) f[0] += b, f[1] += d;
                        f[0] = m(f[0]);
                        f[1] = m(f[1])
                ...
                : function(b) {
                    ...
                    if (c.Dom._canPosition(b)) {
                        ...
                        for (e = p || 519 < a.webkit ? !0 : !1; l = l.offsetParent;)
                            g[0] += l.offsetLeft, g[1] += l.offsetTop, e && (g = c.Dom._calcBorders(l, g));
                        if ("fixed" !== c.Dom._getStyle(b, "position")) {
                            for (l = b; (l = l.parentNode) && l.tagName;)
                                if (b =
                                    ...
                                    (g = c.Dom._calcBorders(l, g)), b || e) g[0] -= e, g[1] -= b;
                            g[0] += d;
                            g[1] += f
        ...
        getX: function(b) { return c.Dom.batch(b, function(b) { return c.Dom.getXY(b)[0] }, c.Dom, !0) },
        getY: function(b) { return c.Dom.batch(b, function(b) { return c.Dom.getXY(b)[1] }, c.Dom, !0) },
        setXY: function(b, a, d) { c.Dom.batch(b, c.Dom._setXY, { pos: a, noRetry: d }) },
        _setXY: function(b,
            a) {
            var d = c.Dom._getStyle(b, "position"),
                ...
                e = a.pos,
                g = a.noRetry,
                l = [parseInt(c.Dom.getComputedStyle(b, "left"), 10), parseInt(c.Dom.getComputedStyle(b, "top"), 10)],
                h;
            ...
            g ||
            (d = c.Dom._getXY(b), (null !== e[0] && d[0] != e[0] ||
                    null !==
                    e[1] &&
                    d[1] != e[1]) &&
                c.Dom._setXY(b, { pos: e, noRetry: !0 }))
        },
        setX: function(b, a) { c.Dom.setXY(b, [a, null]) },
        setY: function(b, a) { c.Dom.setXY(b, [null, a]) },
        getRegion: function(b) {
            return c.Dom.batch(b,
                function(b) {
                    var a = !1;
        ...
        hasClass: function(b, a) { return c.Dom.batch(b, c.Dom._hasClass, a) },
        _hasClass: function(b, a) {
            var d = !1;
            b &&
                a &&
                (d = c.Dom.getAttribute(b, "className") || "", d =
                    a.exec ? a.test(d) : a && -1 < (" " + d + " ").indexOf(" " + a + " "));
            return d
        },
        addClass: function(b, a) { return c.Dom.batch(b, c.Dom._addClass, a) },
        _addClass: function(b, a) {
            var f = !1, e;
            b &&
                a &&
                (e = c.Dom.getAttribute(b, "className") || "", c.Dom._hasClass(b,
                        a) ||
                    (c.Dom.setAttribute(b, "className", d(e + " " + a)), f = !0));
            return f
        },
        removeClass: function(b, a) { return c.Dom.batch(b, c.Dom._removeClass, a) },
        _removeClass: function(b, a) {
            var f = !1, e, g;
            b &&
                a &&
                (e = c.Dom.getAttribute(b, "className") || "",
                    c.Dom.setAttribute(b, "className", e.replace(c.Dom._getClassRegex(a), "")), g =
                        c.Dom.getAttribute(b, "className"), e !== g &&
                    (c.Dom.setAttribute(b, "className", d(g)), f = !0, "" === c.Dom.getAttribute(b, "className") &&
                        (e = b.hasAttribute && b.hasAttribute("class") ? "class" : "className", b.removeAttribute(e))));
            return f
        },
        replaceClass: function(b, a, d) { return c.Dom.batch(b, c.Dom._replaceClass, { from: a, to: d }) },
        _replaceClass: function(b, a) {
            ...
            b &&
                ...
                ((f = a.from, e = a.to, e)
                    ? f
                    ? f !== e &&
                    (g = c.Dom.getAttribute(b, "className") || "", f =
                            (" " + g.replace(c.Dom._getClassRegex(f), " " + e)).split(c.Dom._getClassRegex(e)),
                        f.splice(1, 0, " " + e), c.Dom.setAttribute(b, "className", d(f.join(""))), g = !0)
        ...
        isAncestor: function(b, a) {
            ...
            b &&
                ...
                (b.contains && b !== a
                    ? d = b.contains(a)
                    : b.compareDocumentPosition && (d = !!(b.compareDocumentPosition(a) & 16)));
            return d
        },
        inDocument: function(b, a) { return c.Dom._inDoc(c.Dom.get(b), a) },
        _inDoc: function(b, a) {
            var d = !1;
            b &&
                b.tagName &&
                (a = a || b.ownerDocument, d = c.Dom.isAncestor(a.documentElement,
                    b));
            return d
        },
        ...
        getElementBy: function(b, a, d) { return c.Dom.getElementsBy(b, a, d, null, null, null, !0) },
        ...
        getDocumentHeight: function() {
            return Math.max("CSS1Compat" != k.compatMode || n ? k.body.scrollHeight : l.scrollHeight,
                c.Dom.getViewportHeight())
        },
        getDocumentWidth: function() {
            return Math.max("CSS1Compat" != k.compatMode || n ? k.body.scrollWidth : l.scrollWidth,
        ...
        getAncestorByClassName: function(b, a) {
            return(b = c.Dom.get(b)) ? c.Dom.getAncestorBy(b, function(b) { return c.Dom.hasClass(b, a) }) : null
        },
        getAncestorByTagName: function(b, a) {
            return(b = c.Dom.get(b))
                ? c.Dom.getAncestorBy(b, function(b) { return b.tagName && b.tagName.toUpperCase() == a.toUpperCase() })
                : null
        },
        ...
        getPreviousSibling: function(b) { return(b = c.Dom.get(b)) ? c.Dom.getPreviousSiblingBy(b) : null },
        getNextSiblingBy: function(b, a) {
            for (; b;) if (b = b.nextSibling, c.Dom._testElement(b, a)) return b;
            return null
        },
        getNextSibling: function(b) { return(b = c.Dom.get(b)) ? c.Dom.getNextSiblingBy(b) : null },
        ...
        _toCamel: function(a) {
            function d(b, a) { return a.toUpperCase() }
        ...
        _getClassRegex: function(b) {
            ...
            (b.exec
                ? a = b
                : (a = f[b], a ||
                (b = b.replace(c.Dom._patterns.CLASS_RE_TOKENS,
                    "\\$1"), a = f[b] = new RegExp("(?:^|\\s)" + b + "(?\x3d |$)", "g"))));
            return a
        },
        _patterns: { ROOT_TAG: /^body|html$/i, CLASS_RE_TOKENS: /([\.\(\)\^\$\*\+\?\|\[\]\{\}])/g },
        _testElement: function(b, a) { return b && 1 == b.nodeType && (!a || a(b)) },
    ...
    a.opera &&
    (c.Dom.getComputedStyle = function(b,
        a) {
        var d = r(b, a);
...
(function() {
    var c = YAHOO.util,
        e = /^width|height$/,
        a = /^(\d[.\d]*)+(em|ex|px|gd|rem|vw|vh|vm|ch|mm|cm|in|pt|pc|deg|rad|ms|s|hz|khz|%){1}?/i,
        d = {
            get: function(b, d) {
            ...
            getOffset: function(b, a) {
                ...
                "auto" == d
                    ? (c =
                        d = b[l], e.test(a) && (b.style[a] = d, b[l] > d && (c = d - (b[l] - d)), b.style[a] = "auto"))
            ...
            getColor: function(b, a) { return c.Dom.Color.toRGB(b.currentStyle[a]) || "transparent" },
    ...
    a.Dom.Color = {
        ...
        toHex: function(d) {
            ...
            if (a.Dom.Color.re_RGB.exec(d)) {
                ...
                d = [(1 === e.$1.length ? "0" + e.$1 : Number(e.$1)).toString(16), d.toString(16), b.toString(16)]
                    .join("")
            }
...
YAHOO.util.Subscriber.prototype.contains = function(c, e) { return e ? this.fn == c && this.obj == e : this.fn == c };
...
(YAHOO.util.Event = function() {
    var c = !1,
        ...
        h = [],
        k = 0,
        l = { 63232: 38, 63233: 40, 63234: 37, 63235: 39, 63276: 33, 63277: 34, 25: 9 },
    ...
    return{
        ...
        startInterval: function() {
            if (!this._interval) {
                var b =
                    this;
                this._interval = setInterval(function() { b._tryPreloadAttach() }, this.POLL_INTERVAL)
            }
        },
        onAvailable: function(b, a, d, c, e) {
            b = YAHOO.lang.isString(b) ? [b] : b;
            for (var l = 0; l < b.length; l += 1)
                g.push({ id: b[l], fn: a, obj: d, overrideContext: c, checkReady: e });
            f = this.POLL_RETRYS;
            this.startInterval()
        },
        onContentReady: function(b, a, d, c) { this.onAvailable(b, a, d, c, !0) },
        ...
        _addListener: function(c, f, l, g, m, k) {
            ...
            if (YAHOO.lang.isString(c))
                ...
                else return this.onAvailable(c, function() { YAHOO.util.Event.on(c, f, l, g, m) }), !0;
            if (!c) return!1;
            if ("unload" == f && g !== this) return a[a.length] = [c, f, l, g, m], !0;
            var x = c;
            m && (x = !0 === m ? g : m);
            n = function(b) { return l.call(x, YAHOO.util.Event.getEvent(b, c), g) };
            w = [c, f, l, n, x, g, m];
            e[e.length] = w;
            if (this.useLegacyEvent(c,
                ...
                if (-1 == t || c != d[t][0])
                    t = d.length, h[c.id + f] = t, d[t] = [c, f, c["on" + f]], b[t] = [], c["on" + f] = function(b) {
        ...
        addListener: function(b, a, d, c, f) { return this._addListener(b, a, d, c, f, !1) },
        addFocusListener: function(b, a, d, c) { return this._addListener(b, m, a, d, c, !0) },
        removeFocusListener: function(b, a) {
            return this.removeListener(b,
                m,
                a)
        },
        addBlurListener: function(b, a, d, c) { return this._addListener(b, n, a, d, c, !0) },
        removeBlurListener: function(b, a) { return this.removeListener(b, n, a) },
        fireLegacyEvent: function(a, c) {
            var f = !0, e, l, g;
            e = b[c].slice();
            for (var h = 0, m = e.length; h < m; ++h)
                (l = e[h]) && l[this.WFN] && (g = l[this.ADJ_SCOPE], l = l[this.WFN].call(g, a), f = f && l);
            if ((e = d[c]) && e[2]) e[2](a);
            return f
        },
        ...
        removeListener: function(d, c, f, l) {
            ...
            if ("unload" == c) {
                for (g = a.length - 1; -1 < g; g--)
                    if ((m = a[g]) && m[0] == d && m[1] == c && m[2] == f) return a.splice(g, 1), !0;
                return!1
            }
            g = null;
            ...
            if (this.useLegacyEvent(d,
                ...
                if (k)
                    for (g = 0, h = k.length; g < h; ++g)
                        if ((m = k[g]) && m[this.EL] == d && m[this.TYPE] == c && m[this.FN] == f) {
                            k.splice(g, 1);
                            break
                        }
            } else
        ...
        getTarget: function(b, a) { return this.resolveTextNode(b.target || b.srcElement) },
        ...
        getXY: function(b) { return[this.getPageX(b), this.getPageY(b)] },
        ...
        stopPropagation: function(b) { b.stopPropagation ? b.stopPropagation() : b.cancelBubble = !0 },
        preventDefault: function(b) { b.preventDefault ? b.preventDefault() : b.returnValue = !1 },
        getEvent: function(b, a) {
            var d = b || window.event;
            if (!d)
                for (var c = this.getEvent.caller; c && (!(d = c.arguments[0]) || Event != d.constructor);)
                    c = c.caller;
            return d
        },
        ...
        elCache: {},
        getEl: function(b) { return"string" === typeof b ? document.getElementById(b) : b },
        clearCache: function() {},
        DOMReadyEvent: new YAHOO.util.CustomEvent("DOMReady",
            this),
        _load: function(b) { c || (c = !0, b = YAHOO.util.Event, b._ready(), b._tryPreloadAttach()) },
        _ready: function(b) {
            b = YAHOO.util.Event;
            b.DOMReady ||
                (b.DOMReady = !0, b.DOMReadyEvent.fire(), b._simpleRemove(document, "DOMContentLoaded", b._ready))
        },
        ...
        purgeElement: function(b,
            ...
            if (a && b && b.childNodes)
                for (f = 0, c = b.childNodes.length; f < c; ++f) this.purgeElement(b.childNodes[f], a, d)
        },
        ...
        _unload: function(b) {
            ...
            for (g = a.length; f < g; ++f)
                if (l = h[f])
                    m = window, l[c.ADJ_SCOPE] && (m = !0 === l[c.ADJ_SCOPE] ? l[c.UNLOAD_OBJ] : l[c.ADJ_SCOPE]),
                        l[c.FN].call(m, c.getEvent(b, l[c.EL]), l[c.UNLOAD_OBJ]), h[f] = null;
            a = null;
        ...
        _simpleAdd: function() {
            return window.addEventListener
                ? function(b, a, d, c) { b.addEventListener(a, d, c) }
                : window.attachEvent
                ? function(b, a, d, c) { b.attachEvent("on" + a, d) }
                : function() {}
        }(),
        _simpleRemove: function() {
            return window.removeEventListener
                ? function(b, a, d, c) { b.removeEventListener(a, d, c) }
                : window.detachEvent
                ? function(b, a, d) { b.detachEvent("on" + a, d) }
                : function() {}
        }()
    }
}(), function() {
...
YAHOO.util.EventProvider.prototype = {
    ...
    subscribe: function(c, e, a, d) {
        ...
        b
            ...
            : (b = this.__yui_subscribers =
                this.__yui_subscribers || {}, b[c] || (b[c] = []), b[c].push({ fn: e, obj: a, overrideContext: d }))
    },
    ...
    unsubscribeAll: function(c) { return this.unsubscribe(c) },
    createEvent: function(c, e) {
        ...
        if (!d[c]) {
            ...
            if (a = this.__yui_subscribers[c])
                for (var f = 0; f < a.length; ++f) b.subscribe(a[f].fn, a[f].obj, a[f].overrideContext)
        }
        return d[c]
    },
    ...
    hasEvent: function(c) { return this.__yui_events && this.__yui_events[c] ? !0 : !1 }
};
(function() {
...
(YAHOO.util.DragDropMgr = function() {
    ...
    return{
        ...
        init: function() { this.initialized = !0 },
        POINT: 0,
        INTERSECT: 1,
        STRICT_INTERSECT: 2,
        mode: 0,
        ...
        isDragDrop: function(a) { return this.getDDById(a) ? !0 : !1 },
        ...
        startDrag: function(a, d) {
            ...
            var b =
                this.dragCurrent;
            b && b.events.b4StartDrag && (b.b4StartDrag(a, d), b.fireEvent("b4StartDragEvent", { x: a, y: d }));
            b && b.events.startDrag && (b.startDrag(a, d), b.fireEvent("startDragEvent", { x: a, y: d }));
            this.dragThreshMet = !0
        },
        handleMouseUp: function(a) {
            this.dragCurrent &&
            (clearTimeout(this.clickTimeout), this.dragThreshMet &&
            (this.fromTimeout && (this.fromTimeout = !1, this.handleMouseMove(a)), this.fromTimeout =
                !1, this.fireEvents(a, !0)), this.stopDrag(a), this.stopEvent(a))
        },
        ...
        stopDrag: function(a, d) {
            ...
            b &&
                !d &&
                (this.dragThreshMet &&
                (b.events.b4EndDrag && (b.b4EndDrag(a), b.fireEvent("b4EndDragEvent", { e: a })),
                    b.events.endDrag && (b.endDrag(a), b.fireEvent("endDragEvent", { e: a }))), b.events.mouseUp &&
                    (b.onMouseUp(a), b.fireEvent("mouseUpEvent", { e: a })));
            this._shimActive &&
            (this._deactivateShim(), this.dragCurrent &&
        ...
        handleMouseMove: function(a) {
            ...
            if (d) {
                ...
                this.dragThreshMet &&
                (d && d.events.b4Drag && (d.b4Drag(a), d.fireEvent("b4DragEvent", { e: a })), d &&
                    d.events.drag &&
                    (d.onDrag(a),
        ...
        fireEvents: function(a, d) {
            ...
            if (b && !b.isLocked() && !b.dragOnly) {
                var c = YAHOO.util.Event.getPageX(a),
                    ...
                    l = new YAHOO.util.Region(e.y, e.x + k.offsetWidth, e.y + k.offsetHeight, e.x),
                    m = [],
                    n = {},
                    e = [],
                ...
                for (p in this.dragOvers) {
                    ...
                    this.isTypeOfDD(q) &&
                    (this.isOverTarget(h, q, this.mode, l) || k.outEvts.push(q), m[p] =
                        !0, delete this.dragOvers[p])
                }
                for (var r in b.groups)
                    if ("string" == typeof r)
                        for (p in this.ids[r])
                            q = this.ids[r][p], this.isTypeOfDD(q) &&
                                q.isTarget &&
                                !q.isLocked() &&
                                q != b &&
                                ...
                                (n[r] = !0, d
                                    ? k.dropEvts.push(q)
                                    : (m[q.id] ? k.overEvts.push(q) : k.enterEvts.push(q), this.dragOvers[q.id] = q));
                ...
                d &&
                    !k.dropEvts.length &&
                    (this.interactionInfo.validDrop = !1, b.events.invalidDrop &&
                        (b.onInvalidDrop(a), b.fireEvent("invalidDropEvent", { e: a })));
                for (p = 0; p < c.length; p++)
                    if (r = null, k[c[p] + "Evts"] && (r = k[c[p] + "Evts"]), r && r.length)
                        if (m = c[p].charAt(0).toUpperCase() + c[p].substr(1), v = "onDrag" + m, h = "b4Drag" + m, l =
                            "drag" + m + "Event", m = "drag" + m, this.mode)
                            b.events[h] && (b[h](a, r, e), b.fireEvent(h + "Event", { event: a, info: r, group: e })),
                                b.events[m] &&
                                (b[v](a, r, e), b.fireEvent(l,
                                    {
                                        event: a,
                                        info: r,
                                        group: e
                            ...
                            for (n = 0, q = r.length; n < q; ++n)
                                b.events[h] &&
                                (b[h](a, r[n].id, e[0]), b.fireEvent(h + "Event",
                                    { event: a, info: r[n].id, group: e[0] })), b.events[m] &&
                                    (b[v](a, r[n].id, e[0]), b.fireEvent(l, { event: a, info: r[n].id, group: e[0] }))
            }
        },
        ...
        getLocation: function(a) {
            ...
            e = c + d.offsetWidth;
            b = b[1];
            return new YAHOO.util.Region(b - a.padding[0],
                e + a.padding[1],
                b +
                d.offsetHeight +
                a.padding[2],
        ...
        isOverTarget: function(a, d, b, c) {
            ...
            d.overlap = null;
            c ||
            (a = h.getTargetCoord(a.x, a.y), h = h.getDragEl(), c =
                new YAHOO.util.Region(a.y, a.x + h.offsetWidth, a.y + h.offsetHeight, a.x));
        ...
        getCss: function(a) { return(a = YAHOO.util.Dom.get(a)) ? a.style : null },
        ...
        _addListeners: function() {
            ...
            YAHOO.util.Event && document
                ? a._onLoad()
                : 2E3 < a._timeoutCount ||
                (setTimeout(a._addListeners, 10), document && document.body && (a._timeoutCount += 1))
        },
...
(function() {
    var c = YAHOO.util.Event, e = YAHOO.util.Dom;
    YAHOO.util.DragDrop = function(a, d, b) { a && this.init(a, d, b) };
    YAHOO.util.DragDrop.prototype = {
        ...
        applyConfig: function() {
            ...
            if (this.config.events)
                for (var a in this.config.events) !1 === this.config.events[a] && (this.events[a] = !1);
                ...
                !1 !== b &&
                    ...
                    (this.DDM.refreshCache(this.groups),
                        b = new YAHOO.util.Point(c.getPageX(a), c.getPageY(a)), (
                            ...
                            (this.setStartPosition(), this.DDM.handleMouseDown(a, this), this.DDM.stopEvent(a)))
            }
        },
        ...
        getTargetCoord: function(a, d) {
            ...
            this.constrainX &&
            (b < this.minX && (b = this.minX), b > this.maxX &&
            (b =
                this.maxX));
        ...
        removeInvalidHandleClass: function(a) {
            for (var d = 0, b = this.invalidHandleClasses.length; d < b; ++d)
                this.invalidHandleClasses[d] == a && delete this.invalidHandleClasses[d]
        },
        ...
        setYTicks: function(a, d) {
            ...
            for (c = this.initPageY;
                c <=
                    this.maxY;
                c += d) b[c] || (this.yTicks[this.yTicks.length] = c, b[c] = !0);
        ...
        resetConstraints: function() {
            this.initPageX || 0 === this.initPageX
                ? this.setInitPosition(this.maintainOffset ? this.lastPageX - this.initPageX : 0,
...
YAHOO.extend(YAHOO.util.DD,
    YAHOO.util.DragDrop,
    {
        scroll: !0,
        autoOffset: function(c, e) { this.setDelta(c - this.startPageX, e - this.startPageY) },
        ...
        alignElWithMouse: function(c, e, a) {
            ...
            this.deltaSetXY
                ? (YAHOO.util.Dom.setStyle(c, "left", d.x + this.deltaSetXY[0] + "px"), YAHOO.util.Dom.setStyle(c,
                    "top",
                    d.y + this.deltaSetXY[1] + "px"))
                : (YAHOO.util.Dom.setXY(c,
                    [
                        d.x,
                        d.y
                    ]), e = parseInt(YAHOO.util.Dom.getStyle(c, "left"), 10), a =
                    parseInt(YAHOO.util.Dom.getStyle(c, "top"), 10), this.deltaSetXY = [e - d.x, a - d.y]);
            this.cachePosition(d.x, d.y);
            var b = this;
            setTimeout(function() { b.autoScroll.call(b, d.x, d.y, c.offsetHeight, c.offsetWidth) }, 0)
        },
        ...
        b4Drag: function(c) { this.setDragElPos(YAHOO.util.Event.getPageX(c), YAHOO.util.Event.getPageY(c)) },
        toString: function() { return"DD " + this.id }
    });
YAHOO.util.DDProxy = function(c, e, a) { c && (this.init(c, e, a), this.initFrame()) };
YAHOO.util.DDProxy.dragElId = "ygddfdiv";
YAHOO.extend(YAHOO.util.DDProxy,
    YAHOO.util.DD,
    {
        resizeFrame: !0,
        centerFrame: !1,
        ...
        b4StartDrag: function(c, e) { this.showFrame(c, e) },
        b4EndDrag: function(c) { YAHOO.util.Dom.setStyle(this.getDragEl(), "visibility", "hidden") },
        endDrag: function(c) {
            c = YAHOO.util.Dom;
...
YAHOO.util.DDTarget = function(c, e, a) { c && this.initTarget(c, e, a) };
        ...
        YAHOO.util.DragDrop,
        {
            ...
            initThumb: function(b) {
                ...
                b._isHoriz && b.xTicks && b.xTicks.length
                    ...
                    : b.yTicks && b.yTicks.length && (this.tickPause = Math.round(360 / b.yTicks.length));
                b.onAvailable = function() { return a.setStartSliderState() };
                b.onMouseDown = function() {
                    a._mouseDown = !0;
                    return a.focus()
                };
                b.startDrag = function() { a._slideStart() };
                b.onDrag =
                    function() { a.fireEvents(!0) };
                b.onMouseUp = function() { a.thumbMouseUp() }
            },
            ...
            handleKeyDown: function(b) {
                if (this.enableKeys) {
                    ...
                    (e._isRegion
                        ...
                        : this._setValue(c.SOURCE_KEY_EVENT, e._isHoriz ? h : k, !0), a.stopEvent(b))
                }
            },
            setStartSliderState: function() {
                ...
                this.thumb._isRegion
                    ...
                    ? (this._setRegionValue.apply(this, this.deferredSetRegionValue), this.deferredSetRegionValue =
                        null)
            ...
            setThumbCenterPoint: function() {
                ...
                (this.thumbCenterPoint =
                    { x: parseInt(b.offsetWidth / 2, 10), y: parseInt(b.offsetHeight / 2, 10) })
            },
            lock: function() {
                this.thumb.lock();
                this.locked = !0
            ...
            _setValue: function(b, a, d, e, k) {
                ...
                this._slideStart();
                l._isHoriz
                    ? (m = l.initPageX + a + this.thumbCenterPoint.x, this.moveThumb(m, l.initPageY, d))
                    : (m = l.initPageY + a + this.thumbCenterPoint.y, this.moveThumb(l.initPageX, m, d));
                return!0
            },
            ...
            _setRegionValue: function(b, a, d, e, k, l) {
                var m = this.thumb;
                if (!m.available)
                    return this.deferredSetRegionValue =
                        arguments, !1;
            ...
            verifyOffset: function(b) {
                ...
                return!b || b[0] == this.baselinePos[0] && b[1] == this.baselinePos[1]
                    ? !0
                    : (this.setInitPosition(),
                        this.baselinePos = b, a.initPageX = this.initPageX + a.startOffset[0], a.initPageY =
                            this.initPageY + a.startOffset[1], a.deltaSetXY = null, this.resetThumbConstraints(), !1)
            },
            moveThumb: function(b, a, d, h) {
                var k = this.thumb, l = this, m, n;
                k.available &&
                (k.setDelta(this.thumbCenterPoint.x, this.thumbCenterPoint.y), n = k.getTargetCoord(b, a), m =
                    [Math.round(n.x), Math.round(n.y)], this.animate && k._graduated && !d
                    ? (this.lock(), this.curCoord = e(this.thumb.getEl()), this.curCoord =
                            [Math.round(this.curCoord[0]), Math.round(this.curCoord[1])],
                        setTimeout(function() { l.moveOneTick(m) }, this.tickPause))
                    : this.animate && c.ANIM_AVAIL && !d
                    ? (this.lock(), b =
                        new YAHOO.util.Motion(k.id,
                            { points: { to: m } },
                            this.animationDuration,
                            YAHOO.util.Easing.easeOut), b.onComplete.subscribe(function() {
                        l.unlock();
            ...
            _slideStart: function() {
                this._sliding ||
                    (this._silent || (this.onSlideStart(), this.fireEvent("slideStart")), this._sliding = !0)
            },
            _slideEnd: function() {
                if (this._sliding &&
                    this.moveComplete) {
            ...
            moveOneTick: function(b) {
                ...
                a._isRegion
                    ? (c = this._getNextX(this.curCoord, b), e = null !== c ? c[0] : this.curCoord[0], c =
                        this._getNextY(this.curCoord, b), c = null !== c ? c[1] : this.curCoord[1], c =
                        e !== this.curCoord[0] || c !== this.curCoord[1] ? [e, c] : null)
                    : c = a._isHoriz ? this._getNextX(this.curCoord, b) : this._getNextY(this.curCoord, b);
                c
                    ? (this.curCoord = c, this.thumb.alignElWithMouse(a.getEl(),
                        c[0] + this.thumbCenterPoint.x,
                        c[1] + this.thumbCenterPoint.y), c[0] != b[0] || c[1] != b[1]
                        ? setTimeout(function() { d.moveOneTick(b) }, this.tickPause)
            ...
            _getNextX: function(b, a) {
                ...
                c = null;
                b[0] > a[0]
                    ? (c = d.tickSize - this.thumbCenterPoint.x, c = d.getTargetCoord(b[0] - c, b[1]), c = [c.x, c.y])
                    : b[0] < a[0] &&
                    (c = d.tickSize + this.thumbCenterPoint.x, c = d.getTargetCoord(b[0] + c, b[1]), c = [c.x, c.y]);
                return c
            },
            _getNextY: function(b,
                ...
                c = null;
                b[1] > a[1]
                    ? (c = d.tickSize - this.thumbCenterPoint.y, c = d.getTargetCoord(b[0], b[1] - c), c = [c.x, c.y])
                    : b[1] < a[1] &&
                    (c = d.tickSize + this.thumbCenterPoint.y, c = d.getTargetCoord(b[0], b[1] + c), c = [c.x, c.y]);
                return c
            },
            ...
            fireEvents: function(b) {
                ...
                (a._isRegion
                    ? (b = a.getXValue(), a =
                        a.getYValue(), b == this.previousX && a == this.previousY ||
                        this._silent ||
                        (this.onChange(b, a), this.fireEvent("change", { x: b, y: a })), this.previousX =
                        b, this.previousY = a)
                    : (a = a.getValue(), a == this.previousVal ||
                        this._silent ||
                        (this.onChange(a), this.fireEvent("change", a)), this.previousVal = a))
            },
...
YAHOO.extend(YAHOO.widget.SliderThumb,
    YAHOO.util.DD,
    {
        startOffset: null,
        dragOnly: !0,
        ...
        getOffsetFromParent: function(c) {
            var e = this.getEl(), a;
            this.deltaOffset
                ? (a = parseInt(YAHOO.util.Dom.getStyle(e, "left"), 10), e =
                    parseInt(YAHOO.util.Dom.getStyle(e, "top"), 10), a =
                    [a + this.deltaOffset[0], e + this.deltaOffset[1]])
                : (a = YAHOO.util.Dom.getXY(e),
                    c = c || YAHOO.util.Dom.getXY(this.parentElId), a = [a[0] - c[0], a[1] - c[1]], c =
                        parseInt(YAHOO.util.Dom.getStyle(e, "left"), 10), e =
                        parseInt(YAHOO.util.Dom.getStyle(e, "top"), 10), c -= a[0], e -= a[1], isNaN(c) ||
                        isNaN(e) ||
...
(function() {
    function c(a, b, c, e) {
        ...
        a.onMouseDown = b.onMouseDown = function(b) { return this.backgroundEnabled && h._handleMouseDown(b) };
        a.onDrag = b.onDrag = function(b) { h._handleDrag(b) };
        a.onMouseUp = b.onMouseUp = function(b) { h._handleMouseUp(b) };
        a._bindKeyEvents = function() { h._bindKeyEvents(this) };
    ...
    c.prototype = {
        ...
        maxVal: -1,
        minRange: 0,
        _handleSlideStart: function(a, b) { this.fireEvent("slideStart", b) },
        _handleSlideEnd: function(a, b) { this.fireEvent("slideEnd", b) },
        _handleDrag: function(d) { a.Slider.prototype.onDrag.call(this.activeSlider, d) },
        ...
        setValues: function(a, b, c, e, h) {
            ...
            m._isHoriz
                ? (m.setXConstraint(m.leftConstraint,
                    n.rightConstraint,
                    m.tickSize), n.setXConstraint(m.leftConstraint, n.rightConstraint, n.tickSize))
                : (m.setYConstraint(m.topConstraint, n.bottomConstraint, m.tickSize), n.setYConstraint(m.topConstraint,
                    n.bottomConstraint,
                    n.tickSize));
            this._oneTimeCallback(k,
                "slideEnd",
                function() {
                    q = !0;
                    r &&
                    (p.updateValue(h), setTimeout(function() {
                            p._cleanEvent(k, "slideEnd");
                            p._cleanEvent(l, "slideEnd")
                        },
                        0))
                });
            this._oneTimeCallback(l,
                "slideEnd",
                function() {
                    r = !0;
                    q &&
        ...
        setMinValue: function(a, b, c, e) {
            ...
            this.activeSlider = h;
            k = this;
            this._oneTimeCallback(h,
                "slideEnd",
                function() {
                    k.updateValue(e);
                    setTimeout(function() { k._cleanEvent(h, "slideEnd") }, 0)
                });
            h.setValue(a, b, c)
        },
        ...
        updateValue: function(a) {
            ...
            if (b != this.minVal || c != this.maxVal)
                e = !0, h = this.minSlider.thumb, k = this.maxSlider.thumb, l = this.isHoriz ? "x" : "y", m =
                    this.minSlider.thumbCenterPoint[l] + this.maxSlider.thumbCenterPoint[l], l =
                    Math.max(c - m - this.minRange, 0), m = Math.min(-b - m - this.minRange, 0), this.isHoriz
                    ? (l =
                            Math.min(l, k.rightConstraint), h.setXConstraint(h.leftConstraint, l, h.tickSize),
                        k.setXConstraint(m, k.rightConstraint, k.tickSize))
                    : (l = Math.min(l,
                        k.bottomConstraint), h.setYConstraint(h.leftConstraint, l, h.tickSize), k.setYConstraint(m,
                        k.bottomConstraint,
                        k.tickSize));
            this.minVal = b;
            this.maxVal = c;
        ...
        selectActiveSlider: function(a) {
            ...
            e || h
                ...
                : (a = this.isHoriz
                    ...
                    : k.getPageY(a) - b.thumb.initPageY - b.thumbCenterPoint.y, this.activeSlider =
        ...
        _handleMouseUp: function(d) { a.Slider.prototype.onMouseUp.apply(this.activeSlider, arguments) },
...
YAHOO.util.Attribute = function(c, e) { e && (this.owner = e, this.configure(c, !0)) };
YAHOO.util.Attribute.prototype = {
    ...
    setValue: function(c, e) {
        var a, d = this.owner, b = this.name, f = { type: b, prevValue: this.getValue(), newValue: c };
        if (this.readOnly ||
...
(function() {
    ...
    YAHOO.util.AttributeProvider.prototype = {
        ...
        setAttributes: function(e, a) { for (var d in e) c.hasOwnProperty(e, d) && this.set(d, e[d], a) },
        ...
        register: function(c, a) { this.setAttributeConfig(c, a) },
        ...
        configureAttribute: function(c, a, d) { this.setAttributeConfig(c, a, d) },
...
(function() {
    var c = YAHOO.util.Dom, e = YAHOO.util.AttributeProvider, a = function(a, b) { this.init.apply(this, arguments) };
    a.DOM_EVENTS = {
        click: !0,
        dblclick: !0,
        keydown: !0,
    ...
    a.prototype = {
        ...
        addListener: function(a, b, c, e) {
            ...
            (h &&
                this.DOM_EVENTS[a] &&
                YAHOO.util.Event.addListener(h,
                    a,
                    function(b) {
        ...
        addClass: function(a) { c.addClass(this.get("element"), a) },
        getElementsByClassName: function(a, b) { return c.getElementsByClassName(a, b, this.get("element")) },
        hasClass: function(a) { return c.hasClass(this.get("element"), a) },
        removeClass: function(a) { return c.removeClass(this.get("element"), a) },
        replaceClass: function(a, b) { return c.replaceClass(this.get("element"), a, b) },
        setStyle: function(a, b) {
            return c.setStyle(this.get("element"),
                a,
                b)
        },
        getStyle: function(a) { return c.getStyle(this.get("element"), a) },
        fireQueue: function() {
        ...
        set: function(a, b, c) {
            ...
            if (g)
                return this._configs[a] || YAHOO.lang.isUndefined(g[a]) || this._setHTMLAttrConfig(a), e.prototype.set
                    .apply(this,
                        arguments);
        ...
        _initHTMLElement: function(a) { this.setAttributeConfig("element", { value: c.get(a.element), readOnly: !0 }) },
...
YAHOO.util.Color = function() {
    ...
    return{
        real2dec: function(a) { return Math.min(255, Math.round(256 * a)) },
...
(function() {
    ...
    YAHOO.extend(c,
        YAHOO.util.Element,
        {
            ...
            _numbersOnly: function(a) { return this._hexOnly(a, !0) },
            ...
            _createElements: function() {
                ...
                e = this.get("element");
                a = new k("div", { id: f[this.ID.PICKER_BG], className: "yui-picker-bg", tabIndex: -1, hideFocus: !0 });
                b = new k("div", { id: f[this.ID.PICKER_THUMB], className: "yui-picker-thumb" });
                c = new k("img", { src: h.PICKER_THUMB });
                b.appendChild(c);
                a.appendChild(b);
                e.appendChild(a);
                a = new k("div",
                    { id: f[this.ID.HUE_BG], className: "yui-picker-hue-bg", tabIndex: -1, hideFocus: !0 });
                b = new k("div", { id: f[this.ID.HUE_THUMB], className: "yui-picker-hue-thumb" });
                c = new k("img", { src: h.HUE_THUMB });
                b.appendChild(c);
                a.appendChild(b);
                e.appendChild(a);
                a = new k("div", { id: f[this.ID.CONTROLS], className: "yui-picker-controls" });
                e.appendChild(a);
                e = a;
                ...
                e.appendChild(a);
                e = a;
                a = new k("ul", { id: f[this.ID.RGB_CONTROLS], className: "yui-picker-rgb-controls" });
                b = new k("li");
                ...
                a.appendChild(b);
                e.appendChild(a);
                a = new k("ul", { id: f[this.ID.HSV_CONTROLS], className: "yui-picker-hsv-controls" });
                b = new k("li");
                ...
                a.appendChild(b);
                e.appendChild(a);
                a = new k("ul", { id: f[this.ID.HEX_SUMMARY], className: "yui-picker-hex_summary" });
                ...
                a.appendChild(b);
                e.appendChild(a);
                a = new k("div", { id: f[this.ID.HEX_CONTROLS], className: "yui-picker-hex-controls" });
                a.appendChild(document.createTextNode(g.HEX + " "));
                b = new u("input", { id: f[this.ID.HEX], className: "yui-picker-hex", size: 6, maxlength: 6 });
                a.appendChild(b);
                e.appendChild(a);
                e = this.get("element");
                a = new k("div", { id: f[this.ID.SWATCH], className: "yui-picker-swatch" });
                e.appendChild(a);
                a = new k("div",
                    {
            ...
            _attachRGBHSV: function(a, b) {
                h.on(this.getElement(a), "keydown", function(a, c) { c._rgbFieldKeypress(a, this, b) }, this);
                h.on(this.getElement(a), "keypress", this._numbersOnly, this, !0);
                h.on(this.getElement(a), "blur", function(a, c) { c._useFieldValue(a, this, b) }, this)
            },
            _updateRGB: function() {
            ...
            _initElements: function() {
                ...
                for (c in b)
                    d.hasOwnProperty(b, c) && (e = g.get(b[c]), f = g.generateId(e), b[c] = f, b[b[c]] = f, a[f] = e)
            },
            initPicker: function() {
                this._initSliders();
                this._bindUI();
            ...
            _bindUI: function() {
                ...
                h.on(this.getElement(a.WEBSAFE_SWATCH),
                    "click",
                    function(a) { this.setValue(this.get(b.WEBSAFE)) },
                    this,
                    !0);
                h.on(this.getElement(a.CONTROLS_LABEL),
                    "click",
                    function(a) {
                ...
                h.on(this.getElement(a.HEX), "keydown", function(a, c) { c._hexFieldKeypress(a, this, b.HEX) }, this);
                h.on(this.getElement(this.ID.HEX), "keypress", this._hexOnly, this, !0);
                h.on(this.getElement(this.ID.HEX), "blur", function(a, c) { c._useFieldValue(a, this, b.HEX) }, this)
            },
            syncUI: function(a) {
                this.skipAnim = a;
                this._updateRGB();
            ...
            initAttributes: function(a) {
                ...
                this.setAttributeConfig(this.OPT.VALUE,
                    { value: d.isNumber(a.value) ? a.value : 100, validator: d.isNumber });
                ...
                this.setAttributeConfig(this.OPT.BLUE,
                    { value: d.isNumber(a.blue) ? a.blue : 255, validator: d.isNumber });
                ...
                this.setAttributeConfig(this.OPT.CONTAINER,
                    {
                        value: null,
                        method: function(a) {
                            a && a.showEvent.subscribe(function() { this.pickerSlider.focus() }, this, !0)
                        }
                    });
                this.setAttributeConfig(this.OPT.WEBSAFE, { value: a.websafe || [255, 255, 255] });
                var b =
                        a.ids || d.merge({}, this.ID),
                    h;
                ...
                this.setAttributeConfig(this.OPT.SHOW_RGB_CONTROLS,
                    {
                        ...
                        method: function(a) { this._hideShowEl(this.ID.RGB_CONTROLS, a) }
                    });
                ...
                this.setAttributeConfig(this.OPT.SHOW_HEX_CONTROLS,
                    {
                        ...
                        method: function(a) { this._hideShowEl(this.ID.HEX_CONTROLS, a) }
                    });
                this.setAttributeConfig(this.OPT.SHOW_WEBSAFE,
                    {
                        value: d.isBoolean(a.showwebsafe) ? a.showwebsafe : !0,
                        method: function(a) { this._hideShowEl(this.ID.WEBSAFE_SWATCH, a) }
                    });
...
(function() {
    var c = YAHOO.util, e = function(a, c, b, e) { this.init(a, c, b, e) };
    e.NAME = "Anim";
    e.prototype = {
        toString: function() {
            var a = this.getEl() || {};
        ...
        getAttribute: function(a) {
            ...
            "style" in d
                ? b = h || "absolute" == c.Dom.getStyle(d, "position") && g
                ? d["offset" + e[0].charAt(0).toUpperCase() + e[0].substr(1)]
                : 0
                : a in d && (b = d[a]);
            return b
        },
        getDefaultUnit: function(a) { return this.patterns.defaultUnit.test(a) ? "px" : "" },
        setRuntimeAttribute: function(a) {
            var c, b, e = this.attributes;
            this.runtimeAttributes[a] = {};
            var g = function(a) { return"undefined" !== typeof a };
        ...
        init: function(a, d, b, e) {
            ...
            this.setEl = function(b) { a = c.Dom.get(b) };
            this.getEl = function() { return a };
            this.isAnimated = function() { return g };
            this.getStartTime = function() { return h };
            ...
            this._onTween.subscribe(function() {
                var a = {
                    ...
                    toString: function() { return"duration: " + a.duration + ", currentFrame: " + a.currentFrame }
                };
                this.onTween.fire(a);
...
YAHOO.util.AnimMgr = new function() {
    ...
    this.start = function() { null === c && (c = setInterval(this.run, this.delay)) };
                ...
                if (c.currentFrame < c.totalFrames || null === c.totalFrames) {
                    ...
                    if (c.useSeconds) {
                        var g = c,
                            ...
                            n = 0,
                            n = m < 1E3 * g.duration ? Math.round((m / l - 1) * g.currentFrame) : h - (k + 1);
                        0 < n && isFinite(n) && (g.currentFrame + n >= h && (n = h - (k + 1)), g.currentFrame += n)
                    }
                    c._onTween.fire()
                } else
                    YAHOO.util.AnimMgr.stop(c,
                        a)
        }
    }
};
YAHOO.util.Bezier = new function() {
    this.getPosition = function(c, e) {
        ...
        for (var f = 1; f < a; ++f)
            for (b = 0; b < a - f; ++b)
                d[b][0] = (1 - e) * d[b][0] + e * d[parseInt(b + 1, 10)][0], d[b][1] =
                    (1 - e) * d[b][1] + e * d[parseInt(b + 1, 10)][1];
        return[d[0][0], d[0][1]]
    }
};
(function() {
    var c = function(a, d, e, h) { c.superclass.constructor.call(this, a, d, e, h) };
    c.NAME = "ColorAnim";
    ...
    d.getAttribute = function(b) {
        ...
        if (this.patterns.color.test(b)) {
            ...
            (g = (d = YAHOO.util.Dom.getAncestorBy(d, function(a) { return!h.patterns.transparent.test(g) }))
                ? e.Dom.getStyle(d, b)
                : c.DEFAULT_BGCOLOR)
    ...
    d.setRuntimeAttribute = function(b) {
        ...
        if (this.patterns.color.test(b)) {
            ...
            if ("undefined" === typeof c[b].to && "undefined" !== typeof c[b].by)
                for (var e = this.parseColor(c[b].by), c = 0, k = d.length; c < k; ++c) e[c] = d[c] + e[c];
...
YAHOO.util.Easing = {
    easeNone: function(c, e, a, d) { return a * c / d + e },
    easeIn: function(c, e, a, d) { return a * (c /= d) * c + e },
    easeOut: function(c, e, a, d) { return-a * (c /= d) * (c - 2) + e },
    easeBoth: function(c, e, a, d) { return 1 > (c /= d / 2) ? a / 2 * c * c + e : -a / 2 * (--c * (c - 2) - 1) + e },
    easeInStrong: function(c, e, a, d) { return a * (c /= d) * c * c * c + e },
    easeOutStrong: function(c, e, a, d) { return-a * ((c = c / d - 1) * c * c * c - 1) + e },
    ...
    elasticBoth: function(c, e, a, d, b, f) {
        ...
        return 1 > c
            ? -.5 * b * Math.pow(2, 10 * --c) * Math.sin(2 * (c * d - g) * Math.PI / f) + e
            : b * Math.pow(2, -10 * --c) * Math.sin(2 * (c * d - g) * Math.PI / f) * .5 + a + e
    },
    ...
    bounceIn: function(c, e, a, d) { return a - YAHOO.util.Easing.bounceOut(d - c, 0, a, d) + e },
    bounceOut: function(c, e, a, d) {
        return(c /= d) < 1 / 2.75
            ? 7.5625 * a * c * c + e
            : c < 2 / 2.75
            ? a * (7.5625 * (c -= 1.5 / 2.75) * c + .75) + e
            : c < 2.5 / 2.75
            ? a * (7.5625 * (c -= 2.25 / 2.75) * c + .9375) + e
            : a * (7.5625 * (c -= 2.625 / 2.75) * c + .984375) + e
    },
    bounceBoth: function(c, e, a, d) {
        return c < d / 2
            ? .5 * YAHOO.util.Easing.bounceIn(2 * c, 0, a, d) + e
            : .5 * YAHOO.util.Easing.bounceOut(2 * c - d, 0, a, d) + .5 * a + e
    }
};
(function() {
    var c = function(a, b, d, e) { a && c.superclass.constructor.call(this, a, b, d, e) };
    c.NAME = "Motion";
    var e = YAHOO.util;
    ...
    d.setAttribute = function(b, c, d) {
        this.patterns.points.test(b)
            ? (d = d || "px", a.setAttribute.call(this, "left", c[0], d), a.setAttribute.call(this, "top", c[1], d))
            : a.setAttribute.call(this, b, c, d)
    };
    d.getAttribute = function(b) {
        return this.patterns.points.test(b)
            ? [
                a.getAttribute.call(this, "left"), a.getAttribute.call(this,
                    "top")
            ]
    ...
    d.doMethod = function(b, c, d) {
        var f = null;
        this.patterns.points.test(b)
            ? (c = this.method(this.currentFrame, 0, 100, this.totalFrames) / 100, f =
                e.Bezier.getPosition(this.runtimeAttributes[b], c))
    ...
    d.setRuntimeAttribute = function(c) {
        if (this.patterns.points.test(c)) {
            ...
            if (f(k.points.to))
                for (m = b.call(this, k.points.to, d), e.Dom.getXY(this.getEl()), n = 0, p = l.length; n < p; ++n)
                    l[n] = b.call(this, l[n], d);
            else if (f(k.points.by))
                for (m = [d[0] + k.points.by[0], d[1] + k.points.by[1]], n = 0, p = l.length; n < p; ++n)
    ...
    var b = function(a, b) {
        ...
        f = function(a) { return"undefined" !== typeof a };
    e.Motion = c
})();
(function() {
    var c = function(a, d, e, h) { a && c.superclass.constructor.call(this, a, d, e, h) };
    c.NAME = "Scroll";
    var e = YAHOO.util;
    YAHOO.extend(c, e.ColorAnim);
    var a = c.superclass, d = c.prototype;
