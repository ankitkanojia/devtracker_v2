    ...
    function(b) {
        return{
            ...
            onOk: function() {
                ...
                b &&
                (a = this.getParentEditor(), c =
                    a.document.createElement("input"), c.setAttribute("type", "radio"));
                b && a.insertElement(c);
                            ...
                            commit: function(a) {
                                ...
                                if (CKEDITOR.env.ie) {
                                    ...
                                    (d = CKEDITOR.dom.element.createFromHtml('\x3cinput type\x3d"radio"' +
                                        ...
                                        "\x3e\x3c/input\x3e",
                                        b.document), c.copyAttributes(d, { type: 1, checked: 1 }), d.replace(c), b
                                        .getSelection().selectElement(d), a.element = d)
                                } else
                                    this.getValue()
