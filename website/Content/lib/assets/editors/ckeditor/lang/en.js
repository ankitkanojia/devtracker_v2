...
CKEDITOR.lang["en"] = {
    ...
    "cssanim":
    {
        ...
        "cssPath": "Path ",
        "cssInfo":
            "To remove any custom css, clear the path box<br>To change custom css, enter the css path in the the path box<br>(Any change of css file will require to close the form (OK Button) to be effective !!)",
        ...
        "direction": "Direction",
        "ralTitle":
            "If not checked, this animation &#x0awill be set as 'initial' state transition and &#x0awill happen after completion of any &#x0aother 'click' or 'hover' transitions",
        "forStr": "for",
        ...
        "pbOnClickOnLoadNone":
            "Error, Cannot set this animation to \"Pause OnLoad\" as \"OnLoad\" animation is \"none\"",
    ...
    "bootstrapTabs": {
        ...
        "infoHtml":
            "<p>Add Tabs when activity content can easily be segmented into</p><p>separate tabs to allow for more efficient use of space.<p>",
