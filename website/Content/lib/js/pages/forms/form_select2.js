...
$(function() {
    ...
    $(".change-to-ak-co").on("click",
        function() { $(".select-access-multiple-value").val(["AK", "CO"]).trigger("change"); });
    ...
    $(".access-multiple-disable")
        .on("click", function() { $(".select-access-multiple-enable").prop("disabled", true); });
    $(".access-multiple-enable")
        .on("click", function() { $(".select-access-multiple-enable").prop("disabled", false); });
