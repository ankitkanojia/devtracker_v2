...
!function(a, b) {
    ...
    function(a, b) {
        ...
        n.fn = n.prototype = {
            ...
            proxy: function(a, b) {
                ...
                return"string" == typeof b && (c = a[b], b = a, a = c), n.isFunction(a)
                    ? (e = d.call(arguments, 2), f =
                        function() { return a.apply(b || this, e.concat(d.call(arguments))) }, f.guid = a.guid =
                        a.guid || n.guid++, f)
                    : void 0
            },
            now: Date.now,
        ...
        var t = function(a) {
            ...
            function ga(a, b, d, e) {
                ...
                if ((b ? b.ownerDocument || b : v) !== n && m(b), b = b || n, d = d || [], k =
                    b.nodeType, "string" != typeof a || !a || 1 !== k && 9 !== k && 11 !== k) return d;
                if (!e && p) {
                    if (11 !== k && (f = _.exec(a)))
                        if (j = f[1]) {
                            if (9 === k) {
            ...
            c = ga.support = {}, f = ga.isXML = function(a) {
                ...
                return g !== n && 9 === g.nodeType && g.documentElement
                    ? (n = g, o = g.documentElement, e =
                            g.defaultView,
                        e &&
                            e !== e.top &&
                            (e.addEventListener
                                ? e.addEventListener("unload", ea, !1)
                                : e.attachEvent && e.attachEvent("onunload", ea)), p = !f(g), c.attributes =
                ...
                if ((a.ownerDocument || a) !== n && m(a), b =
                    b.replace(U, "='$1']"), !(!c.matchesSelector || !p || r && r.test(b) || q && q.test(b)))
                    try {
                        var d = s.call(a, b);
            ...
            return h = ga.compile = function(a, b) {
                    ...
                    ja(function(a) { return 1 & a.compareDocumentPosition(n.createElement("div")) }),
                ja(function(a) {
        ...
        var y,
            ...
            A = n.fn.init = function(a, b) {
                ...
                if ("string" == typeof a) {
                    ...
                    return d =
                        l.getElementById(c[2]), d && d.parentNode && (this.length = 1, this[0] = d), this.context =
        ...
        function K() {
            Object.defineProperty(this.cache = {}, 0, { get: function() { return{} } }), this.expando =
                n.expando + K.uid++
        }
        ...
        n.extend({
            ...
            queue: function(a, b, c) {
                ...
                return a
                    ? (b = (b || "fx") + "queue", d =
                            L.get(a, b), c && (!d || n.isArray(c) ? d = L.access(a, b, n.makeArray(c)) : d.push(c)),
                        d || []
                    )
                    : void 0
            },
        ...
        !function() {
            ...
            c.setAttribute("type", "radio"), c.setAttribute("checked", "checked"), c.setAttribute("name", "t"),
                b.appendChild(c), k.checkClone = b.cloneNode(!0).cloneNode(!0).lastChild.checked, b.innerHTML =
        ...
        n.event = {
            ...
            add: function(a, b, c, d, e) {
                ...
                if (r) {
                    c.handler && (f = c, c = f.handler, e = f.selector), c.guid || (c.guid = n.guid++),
                        (i = r.events) || (i = r.events = {}), (g = r.handle) ||
            ...
            trigger: function(b, c, d, e) {
                ...
                if (g = h = d = d || l, 3 !== d.nodeType &&
                    ...
                    (q.indexOf(".") >= 0 && (r = q.split("."), q = r.shift(), r.sort()), k =
                        ...
                        e ? 2 : 3, b.namespace = r.join("."), b.namespace_re =
                    ...
                    return b.type =
                        ...
                        n.isFunction(d[q]) &&
                        !n.isWindow(d) &&
                        (h = d[k], h && (d[k] = null), n.event.triggered = q, d[q](), n.event.triggered =
        ...
        }, n.removeEvent = function(a, b, c) { a.removeEventListener && a.removeEventListener(b, c, !1) }, n.Event =
            function(a, b) {
            ...
            on: function(a, b, c, d, e) {
                ...
                return 1 === e &&
                (f = d, d = function(a) { return n().off(a), f.apply(this, arguments) }, d.guid =
                    f.guid || (f.guid = n.guid++)), this.each(function() { n.event.add(this, a, d, c, b) })
            },
        ...
        n.extend({
            ...
            remove: function(a, b) {
                for (var c, d = a ? n.filter(a, this) : this, e = 0; null != (c = d[e]); e++)
                    b || 1 !== c.nodeType || n.cleanData(oa(c)), c.parentNode &&
            ...
            replaceWith: function() {
                var a = arguments[0];
                return this.domManip(arguments,
                    function(b) { a = this.parentNode, n.cleanData(oa(this)), a && a.replaceChild(b, this) }), a &&
                    (a.length || a.nodeType)
                    ? this
                    : this.remove()
            },
            ...
            domManip: function(a, b) {
                ...
                if (l &&
                (c = n.buildFragment(a, this[0].ownerDocument, !1, this), d =
                    c.firstChild, 1 === c.childNodes.length && (c = d), d)) {
                    for (f = n.map(oa(c, "script"), ka), g = f.length; l > j; j++)
                        h = c, j !== o && (h = n.clone(h, !0, !0), g && n.merge(f, oa(h, "script"))), b.call(this[j],
                            h,
                            j);
                    if (g)
        ...
        !function() {
            ...
            if (f.style) {
                f.style.backgroundClip = "content-box", f.cloneNode(!0).style.backgroundClip = "", k.clearCloneStyle =
                    ...
                    "border:0;height:0;left:-9999px;margin-top:1px;position:absolute; top:0;width:0;", e.appendChild(f);
                            ...
                            reliableMarginRight: function() {
                                ...
                                return c.style.cssText = f.style.cssText =
                                    ...
                                    c.style.marginRight = c.style.width = "0", f.style.width =
                                        ...
                                        !parseFloat(a.getComputedStyle(c, null).marginRight), d.removeChild(e), f
                                        .removeChild(c), b
                            }
                        })
            }
        ...
        n.extend({
                ...
                style: function(a, b, c, d) {
                    if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                        ...
                        return b = n.cssProps[h] || (n.cssProps[h] = Fa(i, h)), g =
                ...
                css: function(a, b, c, d) {
                    ...
                    return b = n.cssProps[h] || (n.cssProps[h] = Fa(a.style, h)), g =
                            n.cssHooks[b] || n.cssHooks[h], g && "get" in g && (e = g.get(a, !0, c)),
                        void 0 === e && (e = xa(a, b, d)), "normal" === e && b in Da && (e = Da[b]), "" === c || c
                    ...
                    n.cssHooks[b] = {
                        get: function(a, c, d) {
                            return c
                                ...
                                ? n.swap(a, Ca, function() { return Ia(a, b, d) })
                                : Ia(a, b, d)
                                : void 0
                        },
                        set: function(a, c, d) {
        ...
        function Va(a, b, c) {
            ...
            if (n.isEmptyObject(m)) "inline" === ("none" === j ? ta(a.nodeName) : j) && (o.display = j);
                ...
                q ? "hidden" in q && (p = q.hidden) : q = L.access(a, "fxshow", {}), f && (q.hidden = !p), p
                    ? n(a).show()
                    : l.done(function() { n(a).hide() }), l.done(function() {
                    var b;
                    L.remove(a, "fxshow");
        ...
        function Xa(a, b, c) {
            ...
            return n.map(k, Ua, j), n.isFunction(j.opts.start) && j.opts.start.call(a, j),
        ...
        n.Animation = n.extend(Xa,
            ...
            13, n.fx.start = function() { Ma || (Ma = setInterval(n.fx.tick, n.fx.interval)) }, n.fx.stop =
            function() { clearInterval(Ma), Ma = null }, n.fx.speeds =
        ...
        }), Za = { set: function(a, b, c) { return b === !1 ? n.removeAttr(a, c) : a.setAttribute(c, c), c } }, n.each(
        ...
        n.extend({
            ...
            ajax: function(a, b) {
                ...
                i = n.event && k.global, i && 0 === n.active++ && n.event.trigger("ajaxStart"), k.type =
                        k.type.toUpperCase(), k.hasContent = !ib.test(k.type), d =
                        k.url, k.hasContent ||
                ...
                function x(a, b, f, h) {
                    var j, r, s, u, w, x = b;
                    2 !== t &&
                    (t = 2, g && clearTimeout(g), c = void 0, e = h || "", v.readyState = a > 0 ? 4 : 0, j =
                            a >= 200 && 300 > a || 304 === a, f && (u = tb(k, v, f)), u =
                            ub(k, u, v, j), j
                            ? (k.ifModified &&
            ...
            serializeArray: function() {
                return this.map(function() {
                    ...
                    return null == c
                        ? null
                        : n.isArray(c)
                        ? n.map(c, function(a) { return{ name: b.name, value: a.replace(xb, "\r\n") } })
        ...
        a.attachEvent && a.attachEvent("onunload", function() { for (var a in Cb) Cb[a]() }), k.cors =
            !!Eb && "withCredentials" in Eb, k.ajax = Eb = !!Eb, n.ajaxTransport(function(a) {
            var b;
            ...
            function(a) { void 0 === a.cache && (a.cache = !1), a.crossDomain && (a.type = "GET") }), n.ajaxTransport(
            "script",
            function(a) {
                if (a.crossDomain) {
                    var b, c;
                ...
                return h || "jsonp" === b.dataTypes[0]
                    ? (e = b.jsonpCallback =
                        ...
                        h
                            ...
                            : b.jsonp !== !1 && (b.url += (db.test(b.url) ? "&" : "?") + b.jsonp + "=" + e), b
                            .converters[
                                "script json"] =
        ...
        n.fn.load = function(a, b, c) {
            ...
            return h >= 0 && (d = n.trim(a.slice(h)), a = a.slice(0, h)),
                n.isFunction(b) ? (c = b, b = void 0) : b && "object" == typeof b && (e = "POST"), g.length > 0 &&
        ...
        n.offset = {
            ...
            function(a, b) {
                n.cssHooks[b] = ya(k.pixelPosition,
                    function(a, c) { return c ? (c = xa(a, b), va.test(c) ? n(a).position()[b] + "px" : c) : void 0 })
        ...
        return n.noConflict =
            function(b) { return a.$ === n && (a.$ = Lb), b && a.jQuery === n && (a.jQuery = Kb), n }, typeof b === U &&
            (a.jQuery = a.$ = n), n
    });